...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/WSMLogger/WSMLogger.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/WSMUtilities/WSMUtilities.bundle"
fi
